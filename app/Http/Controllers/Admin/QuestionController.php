...
class QuestionController extends Controller
{
    ...
    public function store(QuestionCreateRequest $request, $id)
    {
        ...
        return redirect()->route('questions.index',$id)->withSuccess('Question created successfully.');
    }
    ...
    public function edit($quiz_id,$question_id)
    {
       ...
       ?? abort(404,'Question/Quiz not found');
    ...
    public function destroy($quiz_id, $question_id)
    {
        ...
        return redirect()->route('quesitons.index', $quiz_id)->withSuccess('Question deleted successfully.');
    }
}
